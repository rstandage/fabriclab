...
args: -smbios type=1,product=VM-VEX -chardev socket,id=serial0,port=5{},host=0.0.0.0,server=on,wait=off,telnet=on -device isa-serial,chardev=serial0
boot: order=virtio0
cores: 4
cpu: host
memory: 8192
...
net3: virtio={},bridge=vmbr500
net4: virtio={},bridge=vmbr500
numa: 0
onboot: 1
ostype: l24
...
""".format(name, vm_id, name, gen_mac(), gen_mac(), gen_mac(), gen_mac(), gen_mac(), vm_id)
